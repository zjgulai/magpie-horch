...
export function apply(ctx: ClientContext): void {
  ...
  // Adapted for rc.8: shell.right-sidebar slot no longer exists
  // Downgrade to conversation.view as a new tab
  ...
  // TODO: Re-enable when upstream adds this slot back or find alternative
